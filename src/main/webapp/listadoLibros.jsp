	...
	<div class="container d-flex justify-content-center">
		<div class="row w-100">
			<div class="d-flex justify-content-between align-items-end">
				<h1 class="mt-5" style="font-weight:600;">Libros</h1>
				<a class="btn btn-add mb-3"
					role="button"
					href="<%=request.getContextPath()%>/nuevoLibro.jsp">
			...
			<table class="table table-hover mt-3">
				...
				<tbody>
					...
					List<Producto> listado = (List<Producto>) request.getAttribute("libros");
